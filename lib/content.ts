...
export const content: SiteContent = {
  ...
  hero: {
    ...
    typewriter: [
      ...
      "අපි අතර මොන දේවල් වුණත්, මගේ හිතේ ඔයාට තියෙන ආදරේ කවදාවත් වෙනස් වෙන්නේ නැහැ. ❤️",
      "මේ පුංචි surprise එක, ඔයා වෙනුවෙන් හැදුවේ ලොකු මැඩම්... 🎀",
      "ඉතින්... අපේ පුංචි කතාව බලමුද? ✨",
    ],
